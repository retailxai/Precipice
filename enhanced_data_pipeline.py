...
Integrates new data sources with existing Precipice system.
"""
...
logger = logging.getLogger("RetailXAI.EnhancedPipeline")


class EnhancedDataPipeline:
    """Enhanced data pipeline with new data sources."""
    ...
    def _create_companies(self):
        ...
        for company_data in self.config['companies']['companies']:
            company = Company(
                ...
                try:
                    ...
                    for query in search_queries:
                        try:
                            ...
                            videos = youtube_collector._search_youtube(query, max_results=10)
    ...
    def collect_new_sources_data(self):
        ...
        try:
            ...
            self.stats['new_sources_items'] = total_items
    ...
    def run_full_pipeline(self, days_back=60):
        ...
        logger.info("🚀 Enhanced RetailXAI Data Pipeline")
        logger.info("=" * 60)
        logger.info(f"📅 Collecting data from the last {days_back} days")
        logger.info(f"🏢 Processing {len(self.companies)} companies")
        logger.info(f"🆕 Including new data sources")
        logger.info("=" * 60)
...
def main():
    ...
    logger.info("🚀 Starting Enhanced RetailXAI Data Pipeline")
    ...
    if results:
        ...
        logger.error(f"❌ Enhanced pipeline failed. Please check the logs above.")
